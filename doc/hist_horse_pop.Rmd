...
```{r plot horses, fig.cap= "Figure 1. Horse populations for all provinces in Canada between 1940 - 1972", out.width='100%'}
...
```{r plot province, fig.cap = "Figure 2. Horse populations for `r params$province` between 1940 - 1972", fig.width=5, fig.height=4}
